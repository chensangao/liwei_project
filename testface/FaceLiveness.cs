...
namespace testface
{
    ...
    class FaceLiveness
    {
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_depth_liveness_check_by_buf", CharSet = CharSet.Ansi
           , CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_ir_liveness_check", CharSet = CharSet.Ansi
           , CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_ir_liveness_check_faceinfo", CharSet = CharSet.Ansi
           , CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_depth_liveness_check_faceinfo", CharSet = CharSet.Ansi
           , CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_depth_liveness_check", CharSet = CharSet.Ansi
            , CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("BaiduFaceApi.dll", EntryPoint = "rgb_depth_liveness_check_by_orbe", CharSet = CharSet.Ansi
           , CallingConvention = CallingConvention.Cdecl)]
        ...
        public void test_rgb_liveness_check()
        {
            ...
            Console.WriteLine("rgb_liveness_check res is:" + buf);
        }
        ...
        public void test_rgb_liveness_check_by_buf()
        {
            ...
            string buf = Marshal.PtrToStringAnsi(ptr);
            Console.WriteLine("rgb_liveness_check_by_buf res is:" + buf);
        }
        ...
        public void test_rgb_ir_liveness_check_by_opencv()
        {
            ...
            //{
            //    Console.WriteLine("in call back");
            //    if (buf_len > 0)
            //    {
